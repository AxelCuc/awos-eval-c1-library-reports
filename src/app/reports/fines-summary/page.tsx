...
export default async function FinesSummaryPage() {
    ...
    return (
        <div className="container mx-auto p-8 space-y-8">
            <div>
                <h1 className="text-3xl font-bold text-gray-800">Fines Summary</h1>
                <p className="text-gray-500 mt-1">Financial overview of library fines, collected vs pending.</p>
            </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className="text-center">Total Fines Issued</TableHead>
                        ...
                        {data.map((row, i) => (
                            <TableRow key={i}>
                                <TableCell className="font-medium">
                                    {new Date(row.mes).toLocaleDateString(undefined, { year: 'numeric', month: 'long' })}
                                </TableCell>
